...
\begin{abstract}
  Web applications have become more popular in the recent years, due to the "appearence" of modern programming languages and frameworks which allows software developers to create better projects, in terms of performance and reliability.
